...
- **Output for contested/decision questions:** storm-research's adversarial lenses + verification + reliability ranking demonstrably added signal here — it caught hallucinated figures and false corroboration that a plain findings dump passed over. This is the first *observed* (not projected) evidence for the skill's core bet.
